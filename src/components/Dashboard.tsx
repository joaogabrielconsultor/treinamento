  ...
  return (
    <div className="p-8 max-w-6xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-1">Continue aprendendo e evolua sua carreira.</p>
      </div>

      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <StatCard icon={BookOpen}     label="Matriculado"    value={enrolled}   color="bg-brand" />
      ...
      {enrolledCourses.length > 0 && (
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-bold text-gray-900 dark:text-white">Continuar aprendendo</h2>
            <button
              onClick={() => onNavigate('catalog')}
              className="text-brand hover:text-brand-hover text-sm font-medium flex items-center gap-1 transition-colors"
            >
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 text-sm mt-0.5">{course.instructor}</p>
                  ...
                  <div className="flex-shrink-0 w-10 h-10 rounded-full bg-brand-light dark:bg-brand/20 group-hover:bg-brand flex items-center justify-center transition-colors">
                    <Play className="w-4 h-4 text-brand group-hover:text-white transition-colors" />
                  </div>
                </div>
              );
            })}
            ...
            {suggestedCourses.map((course) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <h3 className="font-semibold text-gray-900 dark:text-white mt-2 group-hover:text-brand transition-colors line-clamp-2 text-sm leading-snug">
                    {course.title}
                  </h3>
      ...
      {enrolled === 0 && suggestedCourses.length === 0 && (
        <div className="text-center py-16">
          <div className="w-16 h-16 bg-brand-light dark:bg-brand/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
            <Trophy className="w-8 h-8 text-brand" />
          </div>
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Comece sua jornada!</h3>
          <p className="text-gray-500 dark:text-gray-400 mb-4">Explore nosso catálogo e matricule-se em um curso.</p>
          <button
            onClick={() => onNavigate('catalog')}
