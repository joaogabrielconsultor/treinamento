    ...
    <div className="p-8 max-w-6xl mx-auto">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-500 mt-1">{courses.length} curso{courses.length !== 1 ? 's' : ''} cadastrado{courses.length !== 1 ? 's' : ''}</p>
        </div>
        <button
      ...
      <div className="grid gap-4">
        {courses.map((course) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-gray-500 truncate">{course.description || 'Sem descrição'}</p>
              <div className="flex items-center gap-3 mt-2">
                ...
                <span className="text-xs text-gray-300">•</span>
                <span className="text-xs text-gray-400">{course.duration_minutes} min</span>
                {course.instructor && (
                  <>
                    <span className="text-xs text-gray-300">•</span>
        ...
        {courses.length === 0 && (
          <div className="text-center py-20 bg-white rounded-2xl border border-gray-100">
            ...
            <p className="text-gray-500 mb-4">Nenhum curso cadastrado</p>
            <button
              onClick={handleCreate}
