    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-6">
        ...
        <form onSubmit={submit} className="space-y-4">
          <div>
            <label className="block text-xs font-medium text-gray-500 mb-1">Nome do Banco *</label>
            <input
              type="text"
              value={nome}
          ...
          <div>
            <label className="block text-xs font-medium text-gray-500 mb-1">URL do Banco *</label>
            <input
              type="url"
              value={url}
          ...
          <div className="flex gap-3 pt-1">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-1 px-4 py-2 text-sm text-white bg-blue-600 rounded-xl hover:bg-blue-500 disabled:opacity-50 transition-colors font-medium"
            >
  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm p-6">
        <h2 className="text-lg font-bold text-gray-900 mb-2">Excluir banco?</h2>
    ...
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 hover:shadow-md transition-shadow">
      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold text-gray-900 text-sm">{banco.nome}</h3>
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-2 bg-gray-50 rounded-xl px-3 py-2.5">
          ...
          <span className="text-xs text-gray-500 w-10 flex-shrink-0">Login</span>
          <span className="flex-1 text-sm text-gray-800 font-mono truncate">{banco.login}</span>
        ...
        <div className="flex items-center gap-2 bg-gray-50 rounded-xl px-3 py-2.5">
          ...
          <span className="text-xs text-gray-500 w-10 flex-shrink-0">Senha</span>
        ...
        <div className="flex items-center gap-2 bg-gray-50 rounded-xl px-3 py-2.5">
          ...
          <span className="text-xs text-gray-500 w-10 flex-shrink-0">URL</span>
          <a
            href={banco.url}
            target="_blank"
            rel="noopener noreferrer"
            className="flex-1 text-sm text-blue-600 hover:text-blue-800 truncate underline-offset-2 hover:underline transition-colors"
            title={banco.url}
          >
            {banco.url}
          </a>
  ...
  return (
    <div className="p-8 max-w-5xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Login Bancos</h1>
        ...
        <div className="flex items-center gap-3">
          ...
          {isAdmin && (
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 text-sm text-white bg-blue-600 rounded-xl hover:bg-blue-500 transition-colors font-medium"
            >
      ...
      <div className="relative mb-6">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2.5 text-sm bg-white border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-sm"
        />
        {search && (
          <button
            onClick={() => setSearch('')}
      ...
      {filtered.length > 0 ? (
        ...
        <div className="text-center py-20">
          ...
          {search ? (
            <>
              <p className="text-gray-500 font-medium mb-1">Nenhum banco encontrado</p>
              <p className="text-gray-400 text-sm mb-4">Tente outro termo de busca</p>
              <button
                onClick={() => setSearch('')}
            ...
            <>
              <p className="text-gray-500 font-medium mb-1">Nenhum banco cadastrado</p>
              {isAdmin && (
